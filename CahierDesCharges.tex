...
\begin{tabular}{|c|c|c|c|c|}
 ...
 \hline 
 \cellcolor{lightgray}Script &  & \cellcolor{yellow} & \cellcolor{orange} &  \\ 
 \hline 
 \cellcolor{lightgray}Scénario & \cellcolor{yellow} & \cellcolor{yellow} & \cellcolor{yellow} & \cellcolor{yellow} \\ 
 \hline 
 \cellcolor{lightgray}Site Web &  & \cellcolor{orange} &  &  \\ 
 \hline 
 \cellcolor{lightgray} Réseau & \cellcolor{orange} &  &  & \cellcolor{orange} \\ 
 \hline 
